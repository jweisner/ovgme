...
OvGME is a game mod manager based on the idea and concept of JSGME, it take the GME 
...
disabling mods. OvGME works by comparing the game file tree with the given mod file 
tree, then identifies what files to replace, create and save as backup.
...
Please read carefully the "OvGME and JSGME" chapter of the Help before 
doing anything.
